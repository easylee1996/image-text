...
// @resource   0  file:///Users/miao/Downloads/1.webp
// @connect    api.coze.cn
...
(function (vue) {
  ...
  **/
  ...
  var Icon = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["__file", "icon.vue"]]);
  ...
  const _sfc_main = {
    ...
    setup(__props) {
      ...
      async function change_cover() {
        ...
        const result0 = await my_post("http://192.168.3.238:6174/api/template/submit_title", { title: now_title.value });
        console.log(result0);
        ...
        const filePath = "http://192.168.3.238:6174/api/cover/" + result0.filename;
      ...
      async function add_get_task_button() {
        ...
        if (formEL) {
          ...
          get_task_button_no_question.classList.add("my-get-task-button");
          ...
          task_40_button.classList.add("my-get-task-button");
      ...
      async function listen_title() {
        _GM_setValue("yiyan_content", "");
        _GM_setValue("yiyan_loaded", "false");
        if (location.href.includes("ai.openvam.com")) {
          _GM_addValueChangeListener("yiyan_loaded", function(name, old_value, new_value, remote) {
            if (new_value === "true") {
              _GM_setValue("yiyan_content", now_task_keyword.value);
              _GM_setValue("yiyan_loaded", "false");
            }
          });
        }
        if (location.href.includes("yiyan.baidu.com")) {
          _GM_addValueChangeListener("yiyan_content", async function(name, old_value, new_value, remote) {
            if (new_value) {
          ...
          _GM_setValue("yiyan_loaded", "true");
        }
      }
      ...
      return (_ctx, _cache) => {
        ...
        return show_menu.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
          ...
          vue.createVNode(_component_el_button, {
            type: "primary",
            onClick: _cache[1] || (_cache[1] = ($event) => goto_yiyan())
          }, {
          ...
          vue.withDirectives((vue.openBlock(), vue.createBlock(_component_el_button, {
            type: "danger",
            onClick: _cache[2] || (_cache[2] = ($event) => change_cover()),
          ...
          vue.createVNode(_component_el_button, {
            type: "warning",
            onClick: _cache[3] || (_cache[3] = ($event) => goto_xhs())
          }, {
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ee5b0f0f"]]);
  try {
