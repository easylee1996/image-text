...
(function (vue) {
  ...
  **/
  ...
  const _sfc_main = {
    ...
    setup(__props) {
      ...
      async function inputTitle() {
        ...
        await my_post("http://localhost:6174/paste_title");
      }
      function goto_yiyan() {
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0bb7acdc"]]);
  try {
