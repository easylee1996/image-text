...
`;
        ...
        if (location.href.includes("www.doubao.com")) {
          _GM_addValueChangeListener("doubao", async (name, old_value, new_value, remote) => {
            if (new_value == "true") {
              ...
              editableDiv.focus();
              editableDiv.focus();
              await my_post("http://localhost:6174/input_ai");
              _GM_setValue("doubao", "false");
            }
          });
        }
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-60b13c19"]]);
  try {
