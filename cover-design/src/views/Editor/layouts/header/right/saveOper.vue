<template>
    <a-space>
        ...
        <a-button type="primary" @click="handleExport_direct()">
            <template #icon>
                <icon-download class="m-r-8px" />
            </template>
            直接下载
        </a-button>
    ...
    <a-modal v-model:visible="exportVisible" title="下载作品" @ok="handleExport()" width="600px" :top="50"
        :align-center="false">
...
const handleExport_direct = () => {
    editor.contentFrame.export(`cover.webp`, exportForm.value)
}
